...
- The requests can run in parallel thanks to an abstracted thread pool, through the use of multiple LocalAI horizontally scaled server instances (shout-out to the [LocalAI](https://github.com/mudler/LocalAI) team btw).
